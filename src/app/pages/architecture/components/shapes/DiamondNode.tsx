...
export const DiamondNode = memo(({ data, selected }: DiamondNodeProps) => {
    ...
    <div className="relative">
      ...
      <div className="relative" style={{ width: '160px', height: '160px' }}>
        ...
        >
          ...
          <defs>
            <linearGradient id={`diamond-gradient-${data.id}`} x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <polygon
            ...
            fill={`url(#diamond-gradient-${data.id})`}
            fillOpacity="0.1"
            stroke={borderColor}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-2">
          ...
          {/* Reference */}
          <div className="text-xs font-bold text-gray-900 truncate max-w-[120px] text-center mb-1">
            {data.reference}
          </div>
          
          {/* Part Number */}
          {data.partNumber && (
            <div className="text-[10px] text-gray-700 font-medium truncate max-w-[120px] text-center mb-1">
              {data.partNumber}
            </div>
          )}
          ...
          {/* Manufacturer */}
          {data.manufacturer && (
            <div className="text-[9px] text-gray-500 truncate max-w-[120px] text-center">
              {data.manufacturer}
            </div>
          )}
