...
export type SessionStage = 'overview' | 'upload' | 'discovery' | 'validate' | 'part-identification' | 'system-identification' | 'architecture' | 'requirements' | 'subsystems' | 'compliance' | 'review';
